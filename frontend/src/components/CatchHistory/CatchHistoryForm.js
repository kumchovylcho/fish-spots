...
export default function CatchHistoryForm({ showForm, onSuccess, closeForm }) {
    ...
    return (
        ...
        >
            ...
            <div>
                <label className="block font-semibold mb-1" htmlFor="fish_spot">
                    Рибно място
                </label>
                <input
                    type="text"
            ...
            <div>
                <label className="block font-semibold mb-1" htmlFor="fish_type">
                    Вид риба
                </label>
                <input
                    type="text"
            ...
            <div>
                <label className="block font-semibold mb-1" htmlFor="lure_type">
                    Вид примамка
                </label>
                <input
                    type="text"
